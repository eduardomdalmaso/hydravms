...
const configItems = [
  { id: "video_streams", label: "Fluxo de Vídeo", icon: makeIcon("M23 7l-7 5 7 5V7z M1 5h15v14H1z") },
  { id: "alarms", label: "Alarmes", icon: makeIcon("M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9 M13.73 21a2 2 0 0 1-3.46 0") },
  { id: "workflows", label: "Workflows", icon: makeIcon("M22 11.08V12a10 10 0 1 1-5.93-9.14 M22 4L12 14.01l-3-3") },
  { id: "users", label: "Usuários", icon: makeIcon("M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2 M12 3a4 4 0 1 0 0 8 4 4 0 0 0 0-8z") },
  { id: "layouts", label: "Layouts", icon: makeIcon("M3 3h7v7H3z M14 3h7v7h-7z M14 14h7v7h-7z M3 14h7v7H3z") },
  { id: "carousels", label: "Rondas", icon: makeIcon("M23 4v6h-6 M1 20v-6h6 M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15") },
  { id: "maps", label: "Mapas & Plantas", icon: makeIcon("M1 6v16l7-4 8 4 7-4V2l-7 4-8-4-7 4z M8 2v16 M16 6v16") }
]
const storageItems = [
  { id: "storage", label: "Storage & Discos", icon: makeIcon("M4 6h16M4 12h16M4 18h16") },
  { id: "performance", label: "Performance", icon: makeIcon("M13 2L3 14h9l-1 8 10-12h-9l1-8z") },
  { id: "logs", label: "Logs & Auditoria", icon: makeIcon("M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z M14 2v6h6 M16 13H8 M16 17H8 M10 9H8") }
]

...
<template>
  <div class="vms-flex-col" style="gap: 1rem;">
    ...
    <div class="vms-flex-between">
      ...
      <div v-if="!selectedInstance" class="vms-flex-row" style="gap: 0.5rem; align-items: center;">
        <input v-model="searchQuery" class="vms-auth-input" style="width: 200px; height: 32px; font-size: 12px; padding: 4px 10px; box-sizing: border-box;" placeholder="Filtrar analíticos..." />
        ...
        <button class="vms-btn vms-btn-secondary" style="height: 32px; padding: 0 10px; box-sizing: border-box;" title="Novo Analítico" @click="isWizardOpen = true"><span>+</span><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#ff5e3a" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg></button>
      </div>
    </div>

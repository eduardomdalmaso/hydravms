...
export const mockMarketplaceInstances: AnalyticInstance[] = [
  {
    ...
    name: 'LPR // Portaria Principal - Pista 1',
    camera_id: 'cam_portaria_01',
    camera_name: 'CAM_01 // Portaria Principal',
    stream_type: 'main_1080p',
    hardware_target: 'rtx_5090_cuda',
    confidence_threshold: 0.70,
    roi_mode: 'custom_polygon',
    specific_params: { region: 'mercosul', sahi_enabled: true },
    is_active: true,
    fps_rate: 29.8,
    detections_count: 86,
  ...
  },
  {
    ...
    plugin_id: 'hydra-analytics-lpr',
    plugin_name: 'LPR / ALPR Mercosul & Antigas',
    name: 'LPR // Entrada Garagem Subsolo',
    ...
    roi_mode: 'full_frame',
    specific_params: { region: 'mercosul', sahi_enabled: false },
    is_active: true,
    fps_rate: 30.0,
    detections_count: 62,
  ...
  },
  {
    ...
    name: 'FACIAL // Catracas Hall de Entrada',
    ...
    roi_mode: 'custom_polygon',
    specific_params: { min_face_size: 64, anti_spoof: true },
    is_active: true,
    fps_rate: 28.5,
    detections_count: 94,
  ...
  },
  {
    ...
    name: 'EPI // Área de Carga e Galpão B',
    ...
    confidence_threshold: 0.65,
    roi_mode: 'full_frame',
    specific_params: { require_helmet: true, require_vest: true },
    is_active: true,
    fps_rate: 30.0,
    detections_count: 42,

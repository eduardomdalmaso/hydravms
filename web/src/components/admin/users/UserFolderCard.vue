...
import { ref } from 'vue'
import type { UserFolderNode } from '../../../types/userTree'

const props = defineProps<{ folder: UserFolderNode }>()
const emit = defineEmits<{
  (e: 'open', id: string): void
  (e: 'context', event: MouseEvent, folder: UserFolderNode): void
  (e: 'drop-user', folderId: string): void
}>()
...
const onDrop = (e: DragEvent) => {
  ...
  emit('drop-user', props.folder.id)
}
</script>

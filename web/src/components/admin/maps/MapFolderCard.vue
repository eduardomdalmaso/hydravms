...
import { ref } from 'vue'
import type { MapFolderNode } from '../../../types/mapTree'

const props = defineProps<{ folder: MapFolderNode }>()
const emit = defineEmits<{
  (e: 'open', id: string): void
  (e: 'drop-map', targetFolderId: string): void
}>()

const isDragOver = ref(false)
const onDrop = (e: DragEvent) => {
  e.preventDefault(); isDragOver.value = false; emit('drop-map', props.folder.id)
}
</script>

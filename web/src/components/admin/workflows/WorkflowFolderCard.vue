...
import { ref } from 'vue'
import type { WorkflowFolderNode } from '../../../types/workflowTree'

const props = defineProps<{ folder: WorkflowFolderNode }>()
const emit = defineEmits<{
  (e: 'open', id: string): void
  (e: 'drop-workflow', targetFolderId: string): void
}>()

const isDragOver = ref(false)
const onDrop = (e: DragEvent) => {
  e.preventDefault(); isDragOver.value = false; emit('drop-workflow', props.folder.id)
}
</script>

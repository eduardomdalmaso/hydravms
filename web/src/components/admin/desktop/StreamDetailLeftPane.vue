...
<template>
  <div class="vms-split-pane">
    ...
    <!-- Snapshot / Preview Box (Apenas o Ícone em Laranja, Sem Texto) -->
    <div style="width: 100%; aspect-ratio: 1 / 1; max-height: 480px; background: #07080c; border: 1px solid var(--vms-border); border-radius: 8px; display: flex; align-items: center; justify-content: center;">
      <svg width="64" height="64" viewBox="0 0 576 512" fill="#ff5e3a"><path d="M0 128C0 92.7 28.7 64 64 64H320c35.3 0 64 28.7 64 64V384c0 35.3-28.7 64-64 64H64c-35.3 0-64-28.7-64-64V128zM559.1 99.8c10.4 5.6 16.9 16.4 16.9 28.2V384c0 11.8-6.5 22.6-16.9 28.2s-23 5-32.9-1.6l-112-74.7c-9.8-6.5-16.1-17.4-16.1-29.9V205.1c0-12.5 6.3-23.4 16.1-29.9l112-74.7c9.9-6.6 22.5-7.3 32.9-1.6z"/></svg>
    </div>

    ...
    <div class="vms-modal-dialog">
      <div class="vms-modal-header">
        <h3 class="vms-h3" style="color: var(--vms-neu-accent-orange);">
          {{ isRename ? 'RENOMEAR ZONA DE ALARME' : 'CRIAR NOVA ZONA // PASTA' }}
        </h3>
      ...
      <div class="vms-modal-body">
        <div class="vms-form-group">
          <label class="vms-label">Nome da Zona (Caixa Alta)</label>
          <input v-model="folderName" class="vms-auth-input" style="text-transform: uppercase;" placeholder="EX: PERIMETRO LESTE, GALPAO B" autofocus @keydown.enter="handleSave" />
        </div>
      </div>

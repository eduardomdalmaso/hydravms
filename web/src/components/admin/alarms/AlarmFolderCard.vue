...
import { ref } from 'vue'
import type { AlarmFolderNode } from '../../../types/alarmTree'

const props = defineProps<{ folder: AlarmFolderNode }>()
const emit = defineEmits<{
  (e: 'open', id: string): void
  (e: 'context', event: MouseEvent, folder: AlarmFolderNode): void
  (e: 'drop-alarm', folderId: string): void
}>()
...
const onDrop = (e: DragEvent) => {
  ...
  emit('drop-alarm', props.folder.id)
}
</script>
